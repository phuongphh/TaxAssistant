...
from db.database import async_session, engine as db_engine
from db.models import Base
from db.customer_repository import CustomerRepository
from db.case_repository import CaseRepository
...
PROTO_PATH = str(Path(__file__).resolve().parent.parent / "proto" / "tax_service.proto")
...
class TaxEngineServicer(pb2_grpc.TaxEngineServicer):
    ...
    def _build_error_result(error: Exception) -> dict:
        ...
        from services.ai.llm_client import LLMCreditError, LLMAuthError, LLMRateLimitError, LLMOverloadedError, LLMError
